...
public class TeacherFrame extends javax.swing.JFrame {
    ...
    public TeacherFrame() {
      ...
      private void getTeacher(){
       ...
       try {
           int deptId = bean.getDeptId();
            ...
            Vector v = DBManager.getTeacher(deptId);
     ...
     DepartmentBean selectedBean = (DepartmentBean) this.departmentsComboBox.getSelectedItem();
       ...
       //int cNo=Integer.parseInt(contactNo);
       
       String cNic = cNicTextField.getText();
      // int nic=Integer.parseInt(cNic);
       
        try {
               int row = DBManager.addTeacher(deptId,contactNo,name,fName,surName,dateOfBirth,detaOfAppointment,designatonOfAppointment,currentDesignaton,cNic,email,remarks);
      ...
      private void deleteRecord(){
       ...
       if(bean==null)return;
        try {
            ...
            int row = DBManager.deleteTeacher(bean.getTeacherId());
            if(row>0){
       ...
       private void updateRecord(){
        ...
        try {
            ...
            int row = DBManager.updateTeacher(bean.getTeacherId(),a,nameTextField.getText(),fatherNameTextField.getText(),surNameTextField.getText(),dateOfBirthTextField.getText(),dateOfAppointmentTextField.getText(),DesignatonAppointmentTextField.getText(),currentDesignatonTextField.getText(),cNic,emailTextField.getText(),remarksTextArea.getText());
    ...
    private void initComponents() {
        ...
        getContentPane().add(deleteButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 750, 110, 40));
        ...
        getContentPane().add(updateButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 750, 120, 40));
    ...
    private void departmentsComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_departmentsComboBoxItemStateChanged
        ...
        try {
            Vector v = DBManager.getTeacher(selectedBean.getDeptId());
           teacherNameList.setListData(v);
